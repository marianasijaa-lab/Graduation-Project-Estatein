...
export const ThemeToggleButton: React.FC = () => {
    ...
    return (
        <button
            ...
            className={`fixed bottom-6 right-6 z-50 flex items-center justify-center p-3.5 rounded-full shadow-2xl transition-all duration-300 transform hover:scale-110 active:scale-95 border backdrop-blur-md ${isDark
