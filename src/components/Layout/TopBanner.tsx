      ...
      <div className="site-container flex items-center justify-between gap-2">
        <div className="flex-1 flex items-center justify-center gap-1.5 sm:gap-2 min-w-0 overflow-hidden">
          ...
          <button
            ...
            className="font-medium text-(--text-main) hover:text-[#A37FFB] underline decoration-(--text-main) decoration-1 underline-offset-2 sm:underline-offset-4 cursor-pointer transition-colors text-[9px] sm:text-xs md:text-sm whitespace-nowrap shrink-0"
          >
            {actionText}
          </button>
        </div>
        ...
        <button
          ...
          className=" w-6 h-6 md:w-8 md:h-8 flex items-center justify-center rounded-full border border-bg-gray-1 bg-bg-gray-1 hover:bg-white/10 text-(--text-main)  transition-colors cursor-pointer shrink-0 -mr-5 md:-mr-10"
          aria-label="Close"
        >
