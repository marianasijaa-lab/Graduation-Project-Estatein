...
const properties = [
  ...
  },
  {
    ...
    descriptionLong:
      'Find tranquility in the countryside. This charming cottage is nestled amidst rolling hills and lush greenery, offering a perfect escape from city life with rustic charm and modern comforts.',
    bedrooms: 3,
    bathrooms: 3,
    propertyType: 'Villa',
    bedroomIcon: '/assets/icon_9.png',
  ...
  },
  {
    ...
    descriptionLong:
      "Perched atop one of the city's most prestigious towers, this extraordinary penthouse redefines luxury living. Enjoy 360° panoramic views, a private pool, and bespoke interiors crafted by world-renowned designers.",
    bedrooms: 5,
    bathrooms: 4,
    propertyType: 'Villa',
    bedroomIcon: '/assets/icon_9.png',
...
async function seedCollection(
  ...
  documents.forEach((doc) => {
    const { id, ...rest } = doc as Record<string, unknown> & { id?: string };
    const docRef = id ? colRef.doc(String(id)) : colRef.doc(); // use provided ID or auto-generate
